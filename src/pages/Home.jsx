  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="pt-20 pb-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            <span className="bg-gradient-to-r from-cyan-400 to-cyan-300 bg-clip-text text-transparent">Enterprise-Grade</span><br />
            <span className="bg-gradient-to-r from-cyan-400 to-orange-400 bg-clip-text text-transparent">Intelligent Operations</span>
          </h1>
          
          <p className="text-xl bg-gradient-to-r from-cyan-300 to-orange-300 bg-clip-text text-transparent mb-8 max-w-3xl mx-auto">
      ...
      <section className="py-16 px-6 bg-black">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">
            <span className="bg-gradient-to-r from-cyan-400 to-orange-400 bg-clip-text text-transparent">From Chaos to Control</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-slate-900 to-cyan-950 p-6 rounded-xl border-2 border-cyan-500/30 hover:border-cyan-400 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-cyan-300 mb-2">Manual Workflows</h3>
                  <p className="text-cyan-200/70 text-sm">Teams waste hours on repetitive tasks and data entry across disconnected systems</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-orange-300 mb-2">Intelligent Automation</h3>
                  <p className="text-orange-200/70 text-sm">AI-powered workflows sync data and execute decisions in real-time</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-900 to-cyan-950 p-6 rounded-xl border-2 border-cyan-500/30 hover:border-cyan-400 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-cyan-300 mb-2">Compliance Nightmares</h3>
                  <p className="text-cyan-200/70 text-sm">Tracking SOC2, HIPAA, GDPR across spreadsheets creates audit risks</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-2 bg-cyan-500/20 rounded-lg">
                ...
                <div>
                  <h3 className="font-semibold text-orange-300 mb-2">Built-in Compliance</h3>
                  <p className="text-orange-200/70 text-sm">Automated monitoring and immutable audit logs ensure continuous compliance</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-900 to-cyan-950 p-6 rounded-xl border-2 border-cyan-500/30 hover:border-cyan-400 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-cyan-300 mb-2">Tool Fragmentation</h3>
                  <p className="text-cyan-200/70 text-sm">Dozens of disconnected platforms create data silos and inefficiencies</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-2 bg-cyan-500/20 rounded-lg">
                ...
                <div>
                  <h3 className="font-semibold text-orange-300 mb-2">Unified Platform</h3>
                  <p className="text-orange-200/70 text-sm">Single source of truth connects all systems with intelligent orchestration</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold mb-4">
              <span className="bg-gradient-to-r from-cyan-400 to-orange-400 bg-clip-text text-transparent">Quantify Your Impact</span>
            </h2>
            ...
            <div className="bg-gradient-to-br from-slate-900 to-cyan-950 rounded-xl p-8 border-2 border-cyan-500/40 shadow-xl shadow-cyan-500/20">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="text-center">
                  ...
                  <div className="text-cyan-300 font-semibold">Monthly Savings</div>
                </div>
                <div className="text-center">
                  <div className="text-5xl font-bold text-orange-400 mb-2">
                    ${yearlySavings.toLocaleString()}
                  </div>
                  <div className="text-orange-300 font-semibold">Annual Impact</div>
                </div>
              </div>
      ...
      <section className="py-16 px-6 bg-black">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">
            <span className="bg-gradient-to-r from-cyan-400 to-orange-400 bg-clip-text text-transparent">Deploy in Days, Not Months</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-cyan-300">1. Select Framework</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-orange-300">2. AI Configuration</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-cyan-300">3. Continuous Optimization</h3>
              <p className="text-cyan-200/80">
      ...
      <section className="py-16 px-6 bg-black">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">
            <span className="bg-gradient-to-r from-cyan-400 to-orange-400 bg-clip-text text-transparent">Enterprise Platform Capabilities</span>
          </h2>
      ...
      <section id="demo" className="py-20 px-6 bg-black text-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold mb-4">
              <span className="bg-gradient-to-r from-cyan-400 to-orange-400 bg-clip-text text-transparent">Get Enterprise Assessment</span>
            </h2>
            <p className="text-cyan-300 text-lg">
          ...
          <form onSubmit={handleSubmit} className="bg-gradient-to-br from-cyan-950/50 to-orange-950/50 backdrop-blur-xl p-8 rounded-2xl border-2 border-cyan-400/40 shadow-2xl shadow-cyan-500/30">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block text-sm font-semibold mb-2 text-orange-300">Company *</label>
                <Input
                  required
              ...
              <div>
                <label className="block text-sm font-semibold mb-2 text-orange-300">Industry *</label>
                <Input
                  required
            ...
            <div className="mb-6">
              <label className="block text-sm font-semibold mb-2 text-cyan-300">What are your operational challenges?</label>
              <Textarea
            ...
            <p className="text-sm text-cyan-400/70 text-center mt-4">
      ...
      <footer className="bg-black text-slate-400 py-12 px-6 border-t-2 border-cyan-500/30">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h4 className="font-semibold text-orange-300 mb-4">Company</h4>
              <ul className="space-y-2 text-sm">
            ...
            <div>
              <h4 className="font-semibold text-cyan-300 mb-4">Enterprise</h4>
              <ul className="space-y-2 text-sm">
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <div className="text-center md:text-left">
              <div className="font-medium mb-1">
                <span className="text-cyan-400">Omni</span><span className="text-orange-400">Ops</span> <span className="text-cyan-300">· Intelligent Decision Control</span>
              </div>
              <div className="text-xs text-cyan-500/50">A product of OpsVanta LLC · © 2026 All rights reserved</div>
            </div>
